...
Channel_Internal_Height_1 = 18; //[10:6:72]
//Height (Z axis) including connector (in mm)
Channel_Internal_Height_2 = 12; //[10:6:72]
...
monokiniHeightChangeChannel(lengthMM = lengthMM, widthMM = channelWidth, heightMM1 = Channel_Internal_Height_1, heightMM2 = Channel_Internal_Height_2, anchor = CENTER, orient = TOP, spin = 0, suppress = Suppress_List[0]) //str_pad(Suppress_List[0], Channel_Length_Units, "N")
...
module monokiniHeightChangeChannel(lengthMM = 28, widthMM = 26.4, heightMM1 = 22, heightMM2 = 22, anchor, spin, orient, suppress = ""){
    ...
    Aroff_Profile = offset(deduplicate(AmonokiniProfile), delta=-snapWallThickness, check_valid=true); //create the openGrid profile
    ...
    Broff_Profile = offset(deduplicate(BmonokiniProfile), delta=-snapWallThickness, check_valid=true); //create the openGrid profile
