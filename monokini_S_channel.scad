...
//Approach 2
bez = flatten([
    bez_begin([0,-lengthMM-Grid_Size], BACK, Grid_Size),
    bez_tang([0,-Grid_Size], BACK, Grid_Size),
    bez_tang([dx, dy], BACK, Grid_Size),
    bez_end([dx, dy+lengthMM2], FWD, Grid_Size)
]);
...
color_this(Global_Color) 
  monokiniChannel(lengthMM = lengthMM, widthMM = channelWidth, heightMM = Channel_Total_Height, anchor = CENTER, orient = TOP, spin = 0, suppress = Suppress_List[0], suppressWalls = true)
...
back(lengthMM2/2+dy)
color_this(Global_Color) 
  monokiniChannel(lengthMM = lengthMM2, widthMM = channelWidth, heightMM = Channel_Total_Height, anchor = CENTER, orient = TOP, spin = 0, suppress = Suppress_List[1], suppressWalls = true);
...
module monokiniChannel(lengthMM = 28, widthMM = 26.4, heightMM = 22, anchor, spin, orient, suppress = "", suppressWalls = false) {
