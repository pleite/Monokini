...
// Texture type
Texture_Type = "tri_grid"; // [tri_grid, hex_grid, bricks, checkers, diamonds, pyramids, dots, trunc_diamonds]
...
*/
    ...
    bottom_half(z=heightMM-3.4,s=lengthMM*4) back(lengthMM-Nudge/2) xrot(90) difference() { 
        linear_sweep(monokini_offset_profile(widthMM, heightMM+snapWallThickness), height=lengthMM+Nudge, texture=tex, 
            tex_size=[28,28], tex_depth=0.4);
