...
lengthMM = Diagonal_Channel_Length_in_Units_Y_Axis_Bottom * Grid_Size;
//lengthMM2 = X_Channel_Length_in_Units_X_Axis_Right * Grid_Size;
//lengthMM3 = X_Channel_Length_in_Units_X_Axis_Left * Grid_Size;
lengthMM2 = Diagonal_Channel_Length_in_Units_Y_Axis_Top * Grid_Size;
baseHeight = 3.40;
topHeight = 18.60;
...
t =([[0,-lengthMM-Grid_Size],[0,-Grid_Size],[dx, dy],[dx, dy+lengthMM2]]);
...
color_this(Global_Color)
monokiniChannelPath(path = t, widthMM = channelWidth, heightMM = Channel_Total_Height, anchor = CENTER, orient = TOP, spin = 0, separator = Separator_List[0]);
}
...
module monokiniChannelPath(path, lengthMM = 28, widthMM = 26.4, heightMM = 22, anchor, spin, orient, separator = "") {
